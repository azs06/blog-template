    ...
    return {
      data: [
        ...
        },
        {
          ...
          description:
            "A Cli application to get prayer times on terminal",
        ...
        },
        {
          ...
          description: "A collection of web components, created as part of the Skipper UI library",
        ...
        },
        {
          ...
          description: "A collection of notes, converted to an web app using VitePress",
